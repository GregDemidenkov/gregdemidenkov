<div id="header" align = "center">
    <table>
        <td align = "center">
            ...
            <p><i>$\color{rgb(52,168,140)}{\textsf{«Measuring a programmer's productivity by counting}}$<br>$\color{rgb(52,168,140)}{\textsf{lines of code is like estimating the construction}}$<br>$\color{rgb(52,168,140)}{\textsf{of an aeroplane by its weight.»}}$</i></p>
            <p>$\color{rgb(52,168,140)}{\textsf{© Bill Gates}}$</p>
        </td>
        <td>
...
<div id = "aboutMe">
    ...
    <ul>
        <li>
            <h3>🌏 $\color{rgb(52,168,140)}{\textsf{I`m Frontend developer from Moscow, Russia}}$</h3>
        </li>
        <li>
            <h3>💻 $\color{rgb(52,168,140)}{\textsf{Developing in frontend development for over 2 years}}$</h3>
        </li>
        <li>
            <h3>⌨ $\color{rgb(52,168,140)}{\textsf{Basic technology stack: TypeScript/React/Redux/SCSS}}$</h3>
        </li>
    </ul>
</div>
<br/>
<div id = "technologies">
    ...
    <h3 align = "center">$\color{rgb(52,168,140)}{\textsf{Frontend}}$</h3>
    <div align = "center">
    ...
    <br/>
    <h3 align = "center">$\color{rgb(52,168,140)}{\textsf{Backend}}$</h3>
    <div align = "center"> 
    ...
    <br/>
    <h3 align = "center">$\color{rgb(52,168,140)}{\textsf{Other}}$</h3>
    <div align = "center">
